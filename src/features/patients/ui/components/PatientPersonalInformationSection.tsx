...
export function PatientPersonalInformationSection() {
  ...
  return (
    <Card>
      <CardHeaderWithTitle
        title={t(PATIENTS_KEYS.form.personalInformation, {
          ns: NAMESPACE_KEYS.patient,
        })}
        description={t(PATIENTS_KEYS.form.basicDetails, {
          ns: NAMESPACE_KEYS.patient,
        })}
      />
      <CardContent className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <CustomFormField
            label={t(PATIENTS_KEYS.form.firstName, {
              ns: NAMESPACE_KEYS.patient,
            })}
            name="FirstName"
            required
          ...
          />
          <CustomFormField
            label={t(PATIENTS_KEYS.form.secondName, {
              ns: NAMESPACE_KEYS.patient,
            })}
            name="SecondName"
            required
          ...
          />
          <CustomFormField
            label={t(PATIENTS_KEYS.form.thirdName, {
              ns: NAMESPACE_KEYS.patient,
            })}
            name="ThirdName"
          ...
          />
          <CustomFormField
            label={t(PATIENTS_KEYS.form.lastName, {
              ns: NAMESPACE_KEYS.patient,
            })}
            name="LastName"
            required
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-2">
            <Label className="flex items-center gap-1">
              {t(PATIENTS_KEYS.form.birthDate, { ns: NAMESPACE_KEYS.patient })}
          ...
          <div className="space-y-2">
            <Label className="flex items-center gap-1">
              {t(PATIENTS_KEYS.form.gender, { ns: NAMESPACE_KEYS.patient })}
              <span className="text-destructive">*</span>
            </Label>
            <Controller
              control={form.control}
