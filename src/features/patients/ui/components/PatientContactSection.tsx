...
export function PatientContactSection({ patient }: PatientContactSectionProps) {
  ...
  return (
    <Card>
      <CardHeaderWithTitle
        title={t(PATIENTS_KEYS.form.contactAndIdentification, {
          ns: NAMESPACE_KEYS.patient,
        })}
        description={t(PATIENTS_KEYS.form.contactDetails, {
          ns: NAMESPACE_KEYS.patient,
        })}
      />
      <CardContent className="space-y-4">
        <CustomFormField
          label={t(PATIENTS_KEYS.form.phoneNumber, {
            ns: NAMESPACE_KEYS.patient,
          })}
        ...
        <div className="space-y-4">
          <Label>
            {t(PATIENTS_KEYS.form.identificationDocument, {
              ns: NAMESPACE_KEYS.patient,
            })}
          </Label>
          <Controller
              ...
              >
                <div className="flex items-center space-x-2">
                  ...
                  <Label htmlFor="national">
                    {t(PATIENTS_KEYS.form.nationalId, {
                      ns: NAMESPACE_KEYS.patient,
                    })}
                  </Label>
                </div>
          ...
          {form.watch("idDocumentType") === "national" ? (
            <CustomFormField
              label={t(PATIENTS_KEYS.form.nationalIdNumber, {
                ns: NAMESPACE_KEYS.patient,
              })}
            ...
            <CustomFormField
              label={t(PATIENTS_KEYS.form.passportNumber, {
                ns: NAMESPACE_KEYS.patient,
              })}
              name="PassportNumber"
              placeholder="A123456"
        ...
        <div className="space-y-2">
          <Label className="flex items-center gap-1">
            {t(PATIENTS_KEYS.form.nationality, { ns: NAMESPACE_KEYS.patient })}
          ...
          <Controller
            ...
            render={({ field }) => (
              <CountrySelect
                ...
                placeholder={t(PATIENTS_KEYS.form.selectNationality, {
                  ns: NAMESPACE_KEYS.patient,
                })}
              />
            )}
